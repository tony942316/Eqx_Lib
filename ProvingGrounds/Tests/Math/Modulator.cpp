...
constexpr auto rL = eqx::Radians<long double>{std::numbers::pi_v<long double>};

static_assert(rF.get() == std::numbers::pi_v<float>);
static_assert(r.get() == std::numbers::pi_v<double>);
static_assert(rL.get() == std::numbers::pi_v<long double>);

constexpr auto r0 = eqx::Radians<double>{0.0};
constexpr auto r1 = eqx::Radians<double>{std::numbers::pi * 3.0};
constexpr auto r2 = eqx::Radians<double>{eqx::c_Pi2<double> * 5.0};
constexpr auto r3 = eqx::Radians<double>{eqx::c_2Pi<double>};
constexpr auto r4 = eqx::Radians<double>{-std::numbers::pi};
...
static_assert(r1.get() == std::numbers::pi);
static_assert(r2.get() == eqx::c_Pi2<double>);
static_assert(r3.get() == 0.0);
static_assert(r4.get() == std::numbers::pi);
...
static_assert(eqx::equals(std::make_pair(d0, d0), std::make_pair(d0, d0)));
